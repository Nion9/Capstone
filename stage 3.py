...
model_path = r"N:\UniVERSITY\TRI 2\ST1\Capstone\dataset\converted_keras (1) new\keras_model.h5"
model = tf.keras.models.load_model(model_path)

# Load the labels
labels_path = r"N:\UniVERSITY\TRI 2\ST1\Capstone\dataset\converted_keras (1) new\labels.txt"
